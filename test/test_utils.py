...
class TestUtils(unittest.TestCase):
    ...
    def test_has_nonzero_duplicate_no_duplicates(self):
    ...
    def test_has_nonzero_duplicate_with_duplicates(self):
    ...
    def test_has_nonzero_duplicate_with_zeroes(self):
    ...
    def test_has_nonzero_duplicate_with_zeroes_and_duplicates(self):
